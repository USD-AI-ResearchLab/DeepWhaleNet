...
# 
data = pd.read_csv('./Casey2017.Bm.Ant-A.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Casey2017.Bm.Ant-B.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Casey2017.Bm.Ant-Z.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Casey2017.Bm.D.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Casey2017.Bp.20Hz.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,1)

data = pd.read_csv('./Casey2017.Bp.20Plus.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,1)

data = pd.read_csv('./Casey2017.Bp.Downsweep.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,1)
''' 
#data = pd.read_csv('./Balleny2015.humpback.selections.txt', sep = '\t')
#data2 = pd.read_csv('./Balleny2015.minke.selections.txt', sep = '\t')
data = pd.read_csv('./Casey2017.Unidentified.calls.selections.txt', sep = '\t')
...
pickle.dump(pddf, open('./casey2017DF60FBWhale.pkl', 'wb'))

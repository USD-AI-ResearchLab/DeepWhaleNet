...
# 
data = pd.read_csv('./RossSea2014.Bm.Ant-A.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./RossSea2014.Bm.Ant-B.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./RossSea2014.Bm.Ant-Z.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./RossSea2014.Bm.D.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./RossSea2014.Bp.20Hz.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,1)

data = pd.read_csv('./RossSea2014.Bp.20Plus.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,1)

data = pd.read_csv('./RossSea2014.Bp.DS.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,1)
''' 
data = pd.read_csv('./RossSea2014.unid.selections.txt', sep = '\t')
...
pickle.dump(pddf, open('./RossSea2014DF60FBWhale.pkl', 'wb'))

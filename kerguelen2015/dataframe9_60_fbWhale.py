...
# 
data = pd.read_csv('./Kerguelen2015.Bm.Ant-A.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Kerguelen2015.Bm.Ant-B.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Kerguelen2015.Bm.Ant-Z.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Kerguelen2015.Bm.D.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Kerguelen2015.Fin.20Hz.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,1)

data = pd.read_csv('./Kerguelen2015.Fin.20Plus.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,1)

data = pd.read_csv('./Kerguelen2015.Fin.DS.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,1)
''' 
data = pd.read_csv('./Kerguelen2015.MinkeDS.selections.txt', sep = '\t')
data2 = pd.read_csv('./Kerguelen2015.Unidentified.calls.selections.txt', sep = '\t')
...
pickle.dump(pddf, open('./kerguelen2015DF60FBWhale.pkl', 'wb'))

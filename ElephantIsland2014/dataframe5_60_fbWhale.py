...
# 
data = pd.read_csv('./Bm_Ant-A.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Bm_Ant-B.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Bm_Ant-Z.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Bm_Dcalls.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Bp_20Hz.txt', sep = '\t')
labeler(data,pddf,ss,hop,1)

data = pd.read_csv('./Bp_20Plus.txt', sep = '\t')
labeler(data,pddf,ss,hop,1)
...
pickle.dump(pddf, open('./ElephantIsland2014DF60FBWhale.pkl', 'wb'))

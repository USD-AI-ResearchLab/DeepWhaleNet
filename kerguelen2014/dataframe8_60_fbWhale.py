...
# 
data = pd.read_csv('./Kerguelen2014.Bm.Ant-A.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Kerguelen2014.Bm.Ant-B.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Kerguelen2014.Bm.Ant-Z.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Kerguelen2014.Bm.D.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,0)

data = pd.read_csv('./Kerguelen2014.Bp.20Hz.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,1)

data = pd.read_csv('./Kerguelen2014.Bp.20Plus.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,1)

data = pd.read_csv('./Kerguelen2014.Bp.Downsweep.selections.txt', sep = '\t')
labeler(data,pddf,ss,hop,1)
''' 
#data = pd.read_csv('./Kerguelen2005.MinkeDS.selections.txt', sep = '\t')
data = pd.read_csv('./Kerguelen2014.Unidentified.calls.selections.txt', sep = '\t')
...
pickle.dump(pddf, open('./kerguelen2014DF60FBWhale.pkl', 'wb'))
